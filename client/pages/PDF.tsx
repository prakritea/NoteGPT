...
export default function PDF() {
  ...
  const [history, setHistory] = useState<HistoryItem[]>([
    { id: "1", title: "Research Paper on LLMs", timestamp: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
    { id: "2", title: "Physics Notes", timestamp: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000) },
    { id: "3", title: "Startup Guide", timestamp: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000) },
  ]);
